...
(async function () {
  ...
  try {
    const [regionsResponse, previewsResponse, popupsResponse] = await Promise.all([
      ...
      fetch('data/popups.json?v=20260802-5')
    ]);
